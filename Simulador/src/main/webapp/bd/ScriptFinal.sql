...
values (1, '0131', 'BBVA AGRE.SOLES', 1, 'F');
insert into BBVATESOR.TSI008_FONDO (CD_IDFONDO, CD_COD_FONDO, NB_NOM_FONDO, TP_TIPMONEDA, TP_TIPFONDO)
values (2, '0232', 'BBVA AGRES. USD', 2, 'F');
insert into BBVATESOR.TSI008_FONDO (CD_IDFONDO, CD_COD_FONDO, NB_NOM_FONDO, TP_TIPMONEDA, TP_TIPFONDO)
values (3, '0252', 'BBVA ANDINO', 2, 'F');
insert into BBVATESOR.TSI008_FONDO (CD_IDFONDO, CD_COD_FONDO, NB_NOM_FONDO, TP_TIPMONEDA, TP_TIPFONDO)
values (4, '0121', 'BBVA BALA.SOLES', 1, 'F');
insert into BBVATESOR.TSI008_FONDO (CD_IDFONDO, CD_COD_FONDO, NB_NOM_FONDO, TP_TIPMONEDA, TP_TIPFONDO)
values (5, '0212', 'BBVA BALANCEADO', 2, 'F');
insert into BBVATESOR.TSI008_FONDO (CD_IDFONDO, CD_COD_FONDO, NB_NOM_FONDO, TP_TIPMONEDA, TP_TIPFONDO)
...
insert into BBVATESOR.TSI008_FONDO (CD_IDFONDO, CD_COD_FONDO, NB_NOM_FONDO, TP_TIPMONEDA, TP_TIPFONDO)
values (11, '0031', 'BBVA MODE.SOLES', 1, 'M');
insert into BBVATESOR.TSI008_FONDO (CD_IDFONDO, CD_COD_FONDO, NB_NOM_FONDO, TP_TIPMONEDA, TP_TIPFONDO)
values (12, '0202', 'BBVA MODERADO', 2, 'F');
insert into BBVATESOR.TSI008_FONDO (CD_IDFONDO, CD_COD_FONDO, NB_NOM_FONDO, TP_TIPMONEDA, TP_TIPFONDO)
    ...
    LOOP
      ...
      IF EMISORES.NB_NOM_EMISOR = 'BANCO FALABELLA PERU S.A.' OR EMISORES.NB_NOM_EMISOR = 'SAGA FALABELLA S.A.' THEN
          ...
          BEGIN
            ...
            WHERE T.CD_IDFONDO = V_ID_FONDO
            AND T.CD_IDEMISOR = 'BANCO FALABELLA PERU S.A.';
            EXCEPTION
