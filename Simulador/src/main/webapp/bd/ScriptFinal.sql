...
CREATE  UNIQUE INDEX bbvatesor.ISI012P1_LimFdoEsp ON bbvatesor.TSI012_LimFondoEspecie(cd_idconfiguracion  ASC);
...
CREATE TABLE BBVATESOR.TSI009_EXPOFONDO (	
	...
	TP_MNEMONICO CHAR(1), 
	TP_TOTAL CHAR(1), 
	 CONSTRAINT ISI009P1_EXPOFONDO PRIMARY KEY (CID_EXPO)
  ...
  CREATE UNIQUE INDEX BBVATESOR.ISI009P1_EXPOFONDO ON BBVATESOR.TSI009_EXPOFONDO (CID_EXPO) 
  ...
  ALTER TABLE BBVATESOR.TSI009_EXPOFONDO MODIFY (CID_EXPO NOT NULL ENABLE);
...
*/
  ...
  CREATE SEQUENCE BBVATESOR.SEQ_EXPOFONDO  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;